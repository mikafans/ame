...
use crate::{
    ...
    http::{
        ...
        me::{
            ...
            CreateAgentTokenBody, CreateKeyBody, CreateKeyResponse, KeySummary,
            ListAttemptsResponse, ListKeysResponse, MeResponse, RotateKeyResponse, UpdateAgentBody,
        },
...
#[openapi(
    paths(
        ...
        crate::http::me::list_keys,
        crate::http::me::create_key,
        crate::http::me::rotate_key,
        crate::http::me::revoke_key,
