...
#[openapi(
    ...
    components(schemas(
        ...
        StudyPlanItem,
        CreatePlanBody,
        crate::domain::assessment::Assessment,
        crate::domain::assessment::AssessmentMode,
        crate::domain::assessment::AssessmentStatus,
        crate::domain::assessment::CreateAssessmentRequest,
        crate::domain::assessment::UpdateAssessmentRequest,
        crate::http::assessments::AssessmentSummary,
        crate::http::assessments::AddAssessmentQuestionBody,
        crate::http::assessments::AddAssessmentQuestionResponse,
