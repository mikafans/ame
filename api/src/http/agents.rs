...
pub fn build_skill_manifest() -> Value {
    ...
    let tools = vec![
        ...
        endpoint(
            ...
            "Create an empty, owner-scoped draft course from the learner brief and approved citation certificates. This never inserts generic starter material; author outcomes, modules, instruction, checks, assessment/task work, validate, then publish.",
            "POST",
        ...
        endpoint(
            ...
            "Publish a reviewed course revision. This is the only agent-facing publication command for a course; it revalidates atomically and exposes reviewed activities only if no blocking diagnostic remains.",
            "POST",
